    ...
    return (
      ...
      (e.prototype.createStyleClone = function (A) {
        try {
          ...
          if (
            (this.context.loger.error('Unable to access cssRules property', n),
      ...
      (e.prototype.createCanvasClone = function (A) {
        ...
        try {
          ...
          this.context.loger.info('Unable to clone canvas as it is tainted', A);
        }
        return B;
      }),
      (e.prototype.createVideoClone = function (A) {
        ...
        try {
          ...
          this.context.loger.info('Unable to clone video as it is tainted', A);
        }
          ...
          return _(this, function (l) {
            switch (l.label) {
              ...
              case 7:
                return (
                  l.sent(),
                  this.context.loger.error('Error loading image ' + r.src),
                  [3, 8]
                );
              case 8:
                if (
  ...
  LQ = (function () {
    function e(A, t) {
      ...
      (this.windowBounds = t),
        ...
        (this.loger = new mQ({ id: this.instanceName, enabled: A.loging })),
        (this.cache =
        ...
        switch (oA.label) {
          case 0:
            ...
            return (
              ...
              (n = Lr(
                {
                  loging: (k = A.loging) !== null && k !== void 0 ? k : !0,
                  cache: A.cache,
                },
                B
              )),
          ...
          case 3:
            return (
              ...
              a.loger.debug('Starting DOM parsing'),
              (l = kB(a, w)),
          ...
          case 5:
            return (
              ...
              a.loger.debug('Finished rendering'),
              [2, d]
            );
        }
      });
